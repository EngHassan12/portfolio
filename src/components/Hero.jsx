    ...
    >
      <div className="flex w-full max-w-6xl flex-col items-center text-center md:flex-row md:items-center md:justify-between md:gap-12 md:text-left">
        <div className="order-2 max-w-xl md:order-1">
          ...
          <h2 className="mb-4 text-4xl font-extrabold text-slate-900 md:text-5xl lg:text-6xl">
            Hi, I'm Quuyow
          </h2>
          <p className="mb-8 max-w-xl text-lg text-slate-800">
            I build modern web experiences with clean code, thoughtful design, and a strong focus on user experience.
          </p>
          <a
            href="#projects"
            className="inline-block rounded-lg bg-slate-900 px-6 py-3 font-medium text-white transition hover:bg-slate-800"
          >
            View My Work
          </a>
        </div>
